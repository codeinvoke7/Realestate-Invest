...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1" id="menu-inner">
            <!-- Dashboard -->
            <li class="<?php if (($_SERVER['REQUEST_URI']) == '/admin/dashboard') echo 'active';  ?> menu-item">
            ...
            <li class="menu-header small text-uppercase">
              <span class="menu-header-text">Plan</span>
            </li>
            <li class="<?php if (($_SERVER['REQUEST_URI']) == '/admin/projects') echo 'active'; ?> menu-item">
              <a href="admin/projects" class="menu-link">
              <i class='menu-icon bx bxs-credit-card-front'></i>
                <div data-i18n="Basic">Project Plans</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="cards-basic.html" class="menu-link">
              <i class='menu-icon bx bxs-bar-chart-alt-2'></i>
                <div data-i18n="Basic">Payout Methods</div>
              </a>
            </li>
            <li class="menu-item">
              <a href="cards-basic.html" class="menu-link">
              <i class='menu-icon bx bxs-bank'></i>
                <div data-i18n="Basic">Payouts</div>
              </a>
            </li>
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="forms-basic-inputs.html" class="menu-link">
                    <div data-i18n="Basic Inputs">Create Post</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="forms-input-groups.html" class="menu-link">
                    <div data-i18n="Input groups">Manage Posts</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              ...
              <i class='menu-icon bx bx-globe' ></i>
                <div data-i18n="Form Layouts">Websites</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="form-layouts-vertical.html" class="menu-link">
                    <div data-i18n="Vertical Form">Logo</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="form-layouts-horizontal.html" class="menu-link">
                    <div data-i18n="Horizontal Form">About-us</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="form-layouts-horizontal.html" class="menu-link">
                    <div data-i18n="Horizontal Form">Terms &amp; Conditions</div>
                  </a>
                </li>
              </ul>
            </li>
