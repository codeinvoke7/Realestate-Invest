<footer class="footer pos__rel over__hi">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-4 col-xl-4">
                        <div class="footer__intro">
                            <a href="index.html">
                                <img src="views/assets/images/logo-light.png" alt="Revest" class="logo" />
                            </a>
        ...
        <div class="footer__animation">
            <img src="views/assets/images/footer/footer__left__circle.png" alt="Circle" class="left__circle" />
            <img src="views/assets/images/footer/footer__right__circle.png" alt="Circle" class="right__circle" />
            <img src="views/assets/images/footer/footer__home___illustration.png" alt="Home" class="home__illustration" />
        </div>
    </footer>
