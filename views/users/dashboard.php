                                        ...
                                        <div class="main__content-dashboard__chart">
                                            <div class="balance-report__wrapper dashboard-single__box">
                                                ...
                                                <div class="group">
                                                    <div class="group-inner">
                                                        <p>Amount Invested</p>
                                                        <h6><img src="/views/assets/images/icons/invested.png"
                                                                alt="Invested" />€108.934,00</h6>
                                                    </div>
                                                    <div class="group-inner">
                                                        <p>Total Earnings</p>
                                                        <h6><img src="/views/assets/images/icons/earned.png"
                                            ...
                                            <div class="dashboard-single__box">
                                                <div class="intro">
                                                    ...
                                                    <a href="/users/investment">Show All<i
                                                ...
                                                <div class="property-wrap">
                                                   ...
                                                   $sql = $conn->query("SELECT * FROM `transaction` WHERE user_id = $user_id LIMIT 1");
                                           ...
                                           $row = mysqli_fetch_assoc($projectsql)
                                                          ?>
                                                        <a href="/users/investment">
                                                            <img src="../uploads/projects/<?= $row['thumbnail'] ?>" alt="Los Angeles" />
                                                        </a>
                                                    </div>
                                                    <h4><a href="investment.html"><?= $row['title'] ?></a></h4>
                                        ...
                                        <div class="main__content-dashboard__sidebar">
                                            ...
                                            <div class="dashboard-single__box">
                                                ...
                                                <div class="last-income">
                                                    <div class="group">
                                                        <img src="/views/assets/images/income.png" alt="Last Income" />
                                                        <div>
                                         ...
                                         if (mysqli_num_rows($sql) < 0) {
                                                       ...
                                                       while ($trans = mysqli_fetch_assoc($sql)) {
                                                        $newInvestSql = $conn->query("SELECT * FROM `projects` WHERE id <> '{$trans['project_id']}' LIMIT 3");
                                                       
                                                        
                                                       }
                                                       while ($newInvest = mysqli_fetch_assoc($newInvestSql)) {
                                                       
                                                        ?>
                                                <div class="new-invest">
                                                    <div class="poster">
                                                        <a href="/properties">
                                                            <img src="../uploads/projects/<?= $newInvest['thumbnail'] ?>" alt="San Francisco" />
                                                        </a>
                                                    </div>
                                                    <div class="invest-content">
                                                        <div class="item__head__left">
                                                            <h6><?= $newInvest['title'] ?></h6>
